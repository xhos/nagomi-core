...
const file_nagomi_v1_enums_proto_rawDesc = "" +
	...
	"\x11GRANULARITY_MONTH\x10\x03B\x8d\x01\n" +
	"\rcom.nagomi.v1B\n" +
	"EnumsProtoP\x01Z+nagomi-core/internal/gen/nagomi/v1;nagomiv1\xa2\x02\x03NXX\xaa\x02\tNagomi.V1\xca\x02\tNagomi\\V1\xe2\x02\x15Nagomi\\V1\\GPBMetadata\xea\x02\n" +
