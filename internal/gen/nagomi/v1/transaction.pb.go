...
const file_nagomi_v1_transaction_proto_rawDesc = "" +
	...
	"\x11transaction_count\x18\x03 \x01(\x03R\x10transactionCountB\x93\x01\n" +
	"\rcom.nagomi.v1B\x10TransactionProtoP\x01Z+nagomi-core/internal/gen/nagomi/v1;nagomiv1\xa2\x02\x03NXX\xaa\x02\tNagomi.V1\xca\x02\tNagomi\\V1\xe2\x02\x15Nagomi\\V1\\GPBMetadata\xea\x02\n" +
